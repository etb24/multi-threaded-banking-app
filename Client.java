...
public class Client extends Thread { 
     ...
     */
     ...
     {   
         ...
         //System.out.println("\n DEBUG : Client.run() - starting client thread " + objNetwork.getClientConnectionStatus());

         //check which operation the client is performing
         if (getClientOperation().equals("sending"))
         {
             System.out.println("\n Client sending thread started");
         ...
         {
             System.out.println("\n Client receiving thread started");
