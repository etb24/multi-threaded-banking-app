...
public class Server extends Thread {
	...
	private static String serverThreadRunningStatus1 = "idle";	 /* Running status of thread 1 - idle, running, terminated */
	private static String serverThreadRunningStatus2 = "idle";	 /* Running status of thread 2 - idle, running, terminated */
	private static String serverThreadRunningStatus3 = "idle";	 /* Running status of thread 2 - idle, running, terminated */
       ...
       */
        ...
        */
         ...
         */
         ...
         //Server thread 3 accessor mutator
        	 ...
        	 { 
        		 ...
        		 if (accIndex >= 0) {
            		 ...
            		 if (trans.getOperationType().equals("DEPOSIT"))
            		 {
            			 ...
            			 // Handle the error - account not found
            			 System.out.println("\n Account not found: " + trans.getAccountNumber());
            			 trans.setTransactionStatus("error");
     ...
     */
     ...
     {  double curBalance;      /* Current account balance */
     		...
     		synchronized(account[i]) {
         		...
         		System.out.println("\n DEBUG : Server.deposit - " + "i " + i + " Current balance " + curBalance + " Amount " + amount + " Thread " + getServerThreadId());
     ...
     */
     ...
     {  double curBalance;      /* Current account balance */
     	...
     	synchronized(account[i]) {
            ...
            System.out.println("\n DEBUG : Server.withdraw - " + "i " + i + " Current balance " + curBalance + " Amount " + amount + " Thread " + getServerThreadId());
     ...
     */
     ...
     {  double curBalance;      /* Current account balance */
     	...
     	synchronized(account[i]) {
     		curBalance = account[i].getBalance( );          /* Get current account balance */
     		System.out.println("\n DEBUG : Server.query - " + "i " + i + " Current balance " + curBalance + " Thread " + getServerThreadId()); 
     	}
     ...
     */
     public void run() {
    	    ...
    	    System.out.println("\n DEBUG : Server.run() - starting server thread " + serverThreadId);
    	    
    	    
    	    //set the running status of this thread
    	    if (serverThreadId == "1") {
    	        setServerThreadRunningStatus1("running");
    	    } else if (serverThreadId == "2") {
    	    ...
    	    System.out.println("\n Server thread " + serverThreadId + " terminated - Running time " + (serverEndTime - serverStartTime) + " milliseconds");
    	    
    	    //set the running status of this thread to false
    	    if (serverThreadId == "1") {
    	    ...
    	    //disconnect only when both threads have terminated
